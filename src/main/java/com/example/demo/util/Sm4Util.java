...
public class Sm4Util {
        ...
        if (StringUtils.isNotBlank(params)) {
            ...
            if (!info.isEmpty()) {
                for (Map.Entry<String, Object> entry : info.entrySet()) {
                    ...
                    if (mapValue != null &&
                            (mapValue.toString().contains("%") || mapValue.toString().contains("_")
                                    || mapValue.toString().contains("\\"))) {
    ...
    public static String handleCardid(String cardid, Object idtype) {
        ...
        if ("01".equals(idtype) && cardid.length() >= 4) {
            return StringUtils.isNotBlank(cardid)
                    ? cardid.substring(0, 4) + "****" + cardid.substring(cardid.length() - 4, cardid.length())
                    : null;
        } else {
    ...
    public static void main(String[] args) throws Exception {
        String str = "f03a5dadc6283bfe542fb90eca2ad4e4663954a5c8a207d777e0e64664aca2e836dbe99e8883de8fbbf3e31d9a046a9e15db7ad6f1c80ed43698dbbe89333fdd";
        ...
        map.put("data",
                "[{\"bactPrice\":\"23\",\"bactcode\":\"28\",\"bactname\":\"狂犬病疫苗\",\"corpcode\":\"17\",\"corpname\":\"辽宁成大\",\"jc\":\"1\",\"productname\":\"液体狂犬病疫苗（Vero）\",\"productno\":\"2801\",\"result\":1, \"inocSource\" : \"S\"}]");
